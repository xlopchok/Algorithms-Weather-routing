...
if __name__ == 'main':
    result_isohrones = create_isohrones(
        #data = data,
        start_point = start_point, # Начальная точка
        end_point = end_point, # Коечная точка
        ...
        max_angel = 120, # максимальное допустимое значение угла поворота
        angel_step = 6, # Шаг с которым перебираются углы из указанной области
